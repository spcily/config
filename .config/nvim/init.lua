...
-- plugins are loaded (otherwise wrong leader will be used)
vim.g.mapleader = ' '
...
-- [[ Setting options ]] See `:help vim.o` NOTE: You can change these options
-- as you wish! For more options, you can see `:help option-list`
